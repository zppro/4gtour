...
(function() {
    ...
    angular
        .module('subsystem.merchant-webstore.user-manage',[])
        .controller('MerchantWebStoreUserManageGridController', MerchantWebStoreUserManageGridController)
        .controller('MerchantWebStoreUserManageDetailsController', MerchantWebStoreUserManageDetailsController)
    ;


    MerchantWebStoreUserManageGridController.$inject = ['$scope', 'ngDialog', 'vmh', 'entryVM'];

    function MerchantWebStoreUserManageGridController($scope, ngDialog, vmh, vm) {
        $scope.vm = vm;
    ...
    MerchantWebStoreUserManageDetailsController.$inject = ['$scope', 'ngDialog', 'vmh', 'entityVM'];

    function MerchantWebStoreUserManageDetailsController($scope, ngDialog, vmh, vm) {
